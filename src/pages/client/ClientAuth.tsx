...
export default function ClientAuth() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Assign client role (trigger handles client record creation)
      ...
      toast({
        ...
        description: "Zkontrolujte prosím svůj email pro potvrzení účtu.",
      });
    } catch (error: any) {
      toast({
        variant: "destructive",
      ...
      <Card className="w-full max-w-md relative z-10 border-white/10 bg-white/10 backdrop-blur-xl shadow-2xl text-white">
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            ...
            <CardDescription className="text-blue-100/70 mt-2">Klientský portál</CardDescription>
          </div>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="signin" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-6 bg-white/5 border border-white/10">
              <TabsTrigger value="signin" className="data-[state=active]:bg-blue-600 data-[state=active]:text-white text-blue-100">Přihlášení</TabsTrigger>
              <TabsTrigger value="signup" className="data-[state=active]:bg-blue-600 data-[state=active]:text-white text-blue-100">Registrace</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="signin" className="space-y-4">
              <form onSubmit={handleSignIn} className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="signin-password" className="text-blue-100">Heslo</Label>
                  <Input
                    id="signin-password"
                    type="password"
                    value={password}
            ...
            <TabsContent value="signup" className="space-y-4">
              <form onSubmit={handleSignUp} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="signup-name" className="text-blue-100">Celé jméno</Label>
                  <Input
                    id="signup-name"
                    value={fullName}
                ...
                <div className="space-y-2">
                  <Label htmlFor="signup-phone" className="text-blue-100">Telefon (volitelné)</Label>
                  <Input
                    id="signup-phone"
                    type="tel"
                    value={phone}
                ...
                <div className="space-y-2">
                  <Label htmlFor="signup-password" className="text-blue-100">Heslo</Label>
                  <Input
                    id="signup-password"
                    type="password"
                    value={password}
