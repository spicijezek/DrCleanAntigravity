...
const milestones = [
  { amount: 500, reward: '100 Kč sleva' },
  { amount: 1500, reward: '300 Kč sleva' },
  { amount: 3000, reward: 'Čištění zdarma' },
  { amount: 5000, reward: 'VIP status' },
  { amount: 10000, reward: 'Exkluzivní odměna' },
];
...
export function LoyaltyBannerWithProgress({ currentCredits }: LoyaltyBannerWithProgressProps) {
  ...
  const targetProgressPercentage = progressRange > 0 ? Math.min((progressInRange / progressRange) * 100, 100) : 0;
