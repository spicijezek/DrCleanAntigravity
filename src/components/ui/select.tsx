...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Value
    ...
    className={cn(
      "flex-1 text-left truncate [&[data-placeholder]]:text-foreground/70 text-foreground",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      "grid grid-cols-[1fr_auto] items-center h-10 w-full rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground transition-all hover:border-gray-300 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 [&>span]:text-foreground",
      className
    )}
    {...props}
  >
